...
ki_korr_jahre_point_line_rot <- readRDS("results/figures/Kinderbetreuung/ki_point_line_color.rds")
ki_korr_stadtteile_point_line_sw <- readRDS("results/figures/Kinderbetreuung/ki_simpson_sw.rds")
...
![](images/clipboard-2285594112.png)
...
- **Feinere Datenebene:**
    ...
    - Wir berechnen die bedingte Wahrscheinlichkeit  
      ...
      $P(\text{Die Frau lebt in einem Haushalt mit Kindern} \mid \text{Die Frau ist erwerbstätig})$
      </span>
