...
-   Regionale Unterschiede zwischen den Stadtteilen\
-   In zentralen Stadtteilen höhere Beschäftigungsanteile und stärkere Zuwächse\
-   Periphere Stadtteile geringere Anteile und langsamere Zuwächse
...
$$
P(\text{Die Frau lebt in einem Haushalt mit Kindern} 
  \mid 
  \text{Die Frau ist erwerbstätig})
$$
...
output$map_right_4 <- leaflet::renderLeaflet({
  ...
  pal_4 <- leaflet::colorNumeric("Purples", domain = c(0, 100))
