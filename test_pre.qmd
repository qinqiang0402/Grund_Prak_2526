...
# 全年份的固定坐标轴范围
x_range <- range(df_merged$households_pct, na.rm = TRUE)
y_range <- range(df_merged$emp_female_pct, na.rm = TRUE)
...
output$plot <- renderPlot({
  ...
  ggplot() +
    ...
    geom_point(
      ...
      aes(x = households_pct, y = emp_female_pct),
      color = "grey50",
      alpha = 0.6
    ) +
