...
leaflet_sv_durchschnitt <- readRDS("results/figures/Frauenbeschaeftigung/leaflet_sv_durchschnitt.rds")
...
m_effekt_kor_group <- readRDS("results/figures/moderierender_Effekt/m_effekt_kor_group.rds")
